...
#include "BTT_UseItem_SchoonoogheYoran.h"
#include "AIController.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "Common/InventoryComponent.h"

EBTNodeResult::Type UBTT_UseItem_SchoonoogheYoran::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
	...
	pBlackboardComponent->SetValueAsClass(RequiredItemKey.SelectedKeyName, ItemClass);
