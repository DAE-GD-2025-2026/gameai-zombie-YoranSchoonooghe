...
#include "BTT_LocateItem_SchoonoogheYoran.h"
#include "BehaviorTree/BlackboardComponent.h"

EBTNodeResult::Type UBTT_LocateItem_SchoonoogheYoran::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
