...
#include "BTT_DropWeapon_SchoonoogheYoran.h"
#include "AIController.h"
#include "Items/Weapon.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "Common/InventoryComponent.h"

EBTNodeResult::Type UBTT_DropWeapon_SchoonoogheYoran::ExecuteTask(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory)
{
