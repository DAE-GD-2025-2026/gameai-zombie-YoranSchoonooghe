...
#include "BTD_HasItem_SchoonoogheYoran.h"
#include "AIController.h"
#include "Common/InventoryComponent.h"
#include "BehaviorTree/BlackboardComponent.h"

bool UBTD_HasItem_SchoonoogheYoran::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
	...
	{
		if (pItem->GetItemType() == TargetItemType)
		{
			return true;
		}
	}
