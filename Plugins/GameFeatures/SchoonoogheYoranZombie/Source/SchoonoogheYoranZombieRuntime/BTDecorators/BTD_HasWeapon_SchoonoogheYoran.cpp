...
#include "BTD_HasWeapon_SchoonoogheYoran.h"
#include "AIController.h"
#include "Common/InventoryComponent.h"
#include "Items/Weapon.h"
#include "BehaviorTree/BlackboardComponent.h"

bool UBTD_HasWeapon_SchoonoogheYoran::CalculateRawConditionValue(UBehaviorTreeComponent& OwnerComp, uint8* NodeMemory) const
{
